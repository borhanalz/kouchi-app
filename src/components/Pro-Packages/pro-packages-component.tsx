...
import CountDownTimer from "src/components/CountDowner/CountDownTimer";

import {grey} from "../../theme";
import {GetRequest} from "../../lib/axios";
import {endpoints} from "../../hooks/endPoints";
import {toPersianNumber} from "../../utils/persian-number";
import {IApiServices, IService} from "../../types/services";
import ProPackagesPeyment from "../../sections/pro-packages/pro-packages-peyment";

// ------------------------------------------------------------------------------

export const ProPackagesComponent = () => {
...
export default ProPackagesComponent;
