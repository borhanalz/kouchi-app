...
// --------------------------------------------------------------
export type MobileNumberSchemaType = zod.infer<typeof MobileNumberSchema>;
...
const PhoneNumberStep = () => {
  const methods = useForm<MobileNumberSchemaType>({
  ...
  const { mutateAsync, isPending } = useMutation({
    ...
    mutationFn: (payload: MobileNumberSchemaType) => GetRequest<IApiCheckUser>(endpoints.AUTH.CHECK_USER_SIGNUP_STATUS(payload?.mobileNumber as string))
  })
